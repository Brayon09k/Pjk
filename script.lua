...
pcall(function() game:HttpGet("https://nexviewsservice.shardweb.app/services/drip_client/start")
end)

local Translator = {}

Translator.Frases =
loadstring(game:HttpGet("https://raw.githubusercontent.com/realgengar/Brookhaven/refs/heads/main/translations.lua"))()
...
game:HttpGet("https://raw.githubusercontent.com/realgengar/Library/refs/heads/main/remake.lua",
true)
...
game:HttpGet('https://raw.githubusercontent.com/scriptclient/Brookhaven/refs/heads/main/iploggs.lua
', true)
...
chatLog.Text = [[
â€¢ Add Tab Lags
â€¢ Add news Lag: Box,Book,Guitar [ Troll ]
â€¢ Add Annoy Fling [ Toggle ]
â€¢ Add Lag Select Target Player [ Provied ]
â€¢ add fling couch all v2 [ Button ]
â€¢ add Musics +10 [ Tab Car ]
â€¢ add tornado tool, wall tool, name tool [Character Tab]
â€¢ Fixed bugs
â€¢ ]]
...
Window:Dialog({
    ...
    Text = Translator:traduzir("E aÃ­! VocÃª acaba de dar o play no Drip Client. NÃ£o se preocupe, ele nÃ£o morde a menos que vocÃª entre em nosso discord. EstÃ¡ aqui o melhor Hub. Bora nessa!"),
    Options = {
        {"Discord", function()
             copyDiscordLink()
        end},
...
Tabs.M:AddDiscordInvite({
    ...
    Description = Translator:traduzir("Junte-se Ã nossa comunidade discord para receber informaÃ§Ãµes sobre a prÃ³xima atualizaÃ§Ã£o"),
    Logo = "rbxassetid://",
    Invite = ""
})
...
Window:Dialog({
    Title = Translator:traduzir("Como Obter GrÃ¡tis"),
    Text = Translator:traduzir("â€¢ Formas de conseguir acesso ao Painel Admin Premium:\nVocÃª pode obter de diferentes maneiras\nDando 2 boosts em nosso servidor e recebendo 20 dias de acesso.\nTornando-se um divulgador oficial."),
    Options = {
        {"Discord", function()
            copyDiscordLink()
        end}
...
Tabs.H:AddToggle({
    ...
    Description = Translator:traduzir("Mudar a cor de cabelo automÃ¡tico"),
    Default = false,
    Callback = function(value)
        isHairActive = value
    end
...
Tabs.H:AddToggle({
    ...
    Description = Translator:traduzir("Mudar a cor do nome automÃ¡tico"),
    Default = false,
    Callback = function(value)
        isNameActive = value
    end
...
Tabs.H:AddToggle({
     ...
     Description = Translator:traduzir("Mudar a cor da bio automÃ¡tico"),
     Default = false,
     Callback = function(value)
         isBioActive = value
     end
